    ...
    refresh() {
        this.playerlist = {
          ...
          this.game.alive.forEach((val, key) => {
            if (val.role.priority == 1) this.playerlist.list1.push({ priority: val.role.priority, player: val });
            if (val.role.priority == 2) this.playerlist.list2.push({ priority: val.role.priority, player: val });
            if (val.role.priority == 3) this.playerlist.list3.push({ priority: val.role.priority, player: val });
            if (val.role.priority == 4) this.playerlist.list4.push({ priority: val.role.priority, player: val });
            if (val.role.priority == 5) this.playerlist.list5.push({ priority: val.role.priority, player: val });
            if (val.role.priority == 6) this.playerlist.list4.push({ priority: val.role.priority, player: val });
        });
    }
