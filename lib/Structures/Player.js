...
class Player {
  ...
  votesFor(votee) {
    ...
    revive(reviver) {
        ...
        if (this.game.events.majority && this.game.events.autoScaleMaj == true) this.game.events.majority = this.game.setMaj();
        this.game.playercount++;
        this.game.dead.delete(Player.name);
        this.game.alive.set(Player.name);
    ...
    remove() {
        ...
        if (this.game.alive.has(this.name)) { this.game.alive.delete(this.name); if (this.game.events.majority && this.game.events.autoScaleMaj == true) this.game.events.majority = this.game.setMaj();}
